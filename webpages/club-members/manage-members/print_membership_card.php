...
$memberId = $_GET['id'];
$selectQuery = "SELECT *, role AS membership_type_name FROM members WHERE id = $memberId";
...
<body>
    <div class="card">
        ...
        <div>
        <span class="emboss"><?php echo $memberDetails['address']; ?>

        </div>
        <div>
            <span class="emboss">Membership: <b><?php echo $memberDetails['membership_type_name']; ?></b></span>
