                        ...
                        <form method="POST" action="">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="paid_to" class="form-control" id="paid_to" value="<?= htmlspecialchars($editData['paid_to']) ?>" required>
                                </div>
...
<footer class="main-footer">
    <strong>&copy; <?= date('Y') ?> codeastro.com</strong> - All rights reserved.
